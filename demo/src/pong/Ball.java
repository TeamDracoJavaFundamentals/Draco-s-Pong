...
public class Ball {
    ...
    public void update(Paddle paddle1, Paddle paddle2) {
        ...
        if(this.checkCollision(paddle1) == 1) {                 // a tezi 2te proverqvat za paddle-ite
            this.motionX = 1 + this.amountOfHits / 5;           // kato se uveli4ava skorostta na vseki 5 udara
        ...
        if(this.checkCollision(paddle1) == 2) {                 // v slu4ai 4e tazi funkciq checkCollision v1rne 2
            ++paddle2.score;                                       // a ne 1 ozna4ava 4e playera e propusnal top4eto
            this.spawn();                                               // respawnva top4eto po sredata
